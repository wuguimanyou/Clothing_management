...
if(!empty($_POST["parent_types_select"])){
  $parent_class = $_POST["parent_types_select"];
  if($parent_class!=-1){
	  $parent_pid = $_POST["parent_pid_select"];
  }
}
...
$is_dis_model = $_POST["is_dis_model"];//是否保存过分销模式
...
fwrite($f, "====is_dis_model===".$_POST["is_dis_model"]."\r\n");  
 if($shop_id>0){
 //2015-03-11修改，插入提现时间
   // $sql="update weixin_commonshops set is_applymoney=".$is_applymoney.",reward_level=".$reward_level.",exp_name='".$exp_name."',nopostage_money=".$nopostage_money.",auto_upgrade_money_2=".$auto_upgrade_money_2.", introduce='".$introduce."',per_share_score=".$per_share_score.",is_showshare_info=".$is_showshare_info.",is_showdiscuss=".$is_showdiscuss.",shop_card_id = ".$shop_card_id.",is_autoupgrade=".$is_autoupgrade.",auto_upgrade_money=".$auto_upgrade_money.",is_showbottom_menu=".$is_showbottom_menu.",distr_type=".$distr_type.",member_template_type=".$member_template_type.",is_attent=".$is_attent.",attent_url='".$attent_url."',auto_confirmtime=".$auto_confirmtime.",online_type=".$online_type.",sell_detail='".$sell_detail."',detail_template_type=".$detail_template_type.",online_qq='".$online_qq."',need_online=".$need_online.",sell_discount=".$sell_discount.",reward_type=".$reward_type.",init_reward=".$init_reward.",name='".$name."',email='".$email."',need_customermessage=".$need_customermessage.",need_email=".$need_email.",issell=".$issell.",isprint=".$isprint.",gz_url='".$gz_url."',exp_mem_name='".$exp_mem_name."',watertype=".$watertype.",exp_pic_text1='".$exp_pic_text1."',exp_pic_text2='".$exp_pic_text2."',exp_pic_text3='".$exp_pic_text3."' where id=".$shop_id;
	$sql="update weixin_commonshops set is_godefault=".$is_godefault.",is_applymoney=".$is_applymoney.",staff_imgurl='".$staff_imgurl."',reward_level=".$reward_level.",exp_name='".$exp_name."',nopostage_money=".$nopostage_money.",auto_upgrade_money_2=".$auto_upgrade_money_2.", introduce='".$introduce."',per_share_score=".$per_share_score.",is_showshare_info=".$is_showshare_info.",is_showdiscuss=".$is_showdiscuss.",shop_card_id = ".$shop_card_id.",is_autoupgrade=".$is_autoupgrade.",auto_upgrade_money=".$auto_upgrade_money.",is_showbottom_menu=".$is_showbottom_menu.",distr_type=".$distr_type.",member_template_type=".$member_template_type.",is_attent=".$is_attent.",attent_url='".$attent_url."',auto_confirmtime=".$auto_confirmtime.",auto_cus_time=".$auto_cus_time.",online_type=".$online_type.",sell_detail='".$sell_detail."',detail_template_type=".$detail_template_type.",online_qq='".$online_qq."',need_online=".$need_online.",sell_discount=".$sell_discount.",reward_type=".$reward_type.",init_reward=".$init_reward.",name='".$name."',email='".$email."',need_customermessage=".$need_customermessage.",need_email=".$need_email.",issell=".$issell.",isprint=".$isprint.",gz_url='".$gz_url."',exp_mem_name='".$exp_mem_name."',watertype=".$watertype.",exp_pic_text1='".$exp_pic_text1."',exp_pic_text2='".$exp_pic_text2."',exp_pic_text3='".$exp_pic_text3."',is_applymoney_startdate=".$is_applymoney_startdate.",is_applymoney_enddate=".$is_applymoney_enddate.",is_applymoney_minmoney='".$is_applymoney_minmoney."',is_pic=".$is_pic.",define_share_image='".$define_share_image."',isOpenSupply=".$isOpenSupply.",isOpenAgent=".$isOpenAgent.",promoter_bg_imgurl='".$promoter_bg_imgurl."',parent_ps='".$parent_ps."',template_head_bg='".$template_head_bg."',is_dis_model=".$is_dis_model.",issell_model=".$issell_model.",parent_class='".$parent_class."',parent_pid='".$parent_pid."',stock_remind=".$stock_remind.",isOpenInstall=".$isOpenInstall.",is_identity=".$is_identity.",per_identity_num='".$per_identity_num."',is_cost_limit=".$is_cost_limit.",per_cost_limit='".$per_cost_limit."',is_weight_limit=".$is_weight_limit.",per_weight_limit='".$per_weight_limit."',isOpenPublicWelfare=".$isOpenPublicWelfare.",bottom_support_imgurl='".$bottom_support_imgurl."',is_bottom_support=".$is_bottom_support.",bottom_support_cont='".$bottom_support_cont."' where id=".$shop_id;	
	fwrite($f, "====sql===".$sql."\r\n");  
	//echo $sql;
