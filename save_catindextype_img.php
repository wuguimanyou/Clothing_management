...
$cat_index_imgurl=$configutil->splash_new($_POST["cat_index_imgurl"]);
...
mysql_query("update weixin_commonshop_types set cat_index_imgurl='".$cat_index_imgurl."' where id=".$keyid);
