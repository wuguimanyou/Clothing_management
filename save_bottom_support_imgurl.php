...
$destination_folder="up/bottom_support/"; //上传文件路径
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	//是否存在文件
	{
	   if($keyid<=0){
	       ...
	       $destination = $_POST["bottom_support_imgurl"];
	   }
	}else{
		$file = $_FILES["upfile"];
 ...
 echo "<script>location.href='iframe_images_bottom_support.php?customer_id=".$customer_id_en."&bottom_support_imgurl=".$destination."';</script>";
 }
?>