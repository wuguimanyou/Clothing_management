...
$destination_folder="../up/pro_logo/"; //上传文件路径
...
$destination = "";
 ...
 $pt_id =$configutil->splash_new($_POST["pt_id"]);
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 //echo $parent_id;
 //echo $destination;
 echo "<script>location.href='product_type_catindeximg.php?customer_id=".$customer_id_en."&type_imgurl=".$destination."&keyid=".$keyid."';</script>";
 }
?>